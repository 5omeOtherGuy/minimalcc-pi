...
- `native-credentials.test.ts` — fake-file tests for Claude Code OAuth credential loading, expired-token refresh, macOS Keychain fallback, and OAuth-only native headers.
