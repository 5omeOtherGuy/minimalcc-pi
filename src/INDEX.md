...
- `credentials.ts` — Claude Code OAuth credential path resolution, fake-testable token loading, expired-token refresh/persistence, and macOS Keychain fallback.
