...
export const MODELS = [
  claudeSubscriptionModel("claude-haiku-4-5", "Claude Haiku 4.5 (Claude Code subscription)", 200000, 48000, CLAUDE_SUBSCRIPTION_BUDGET_THINKING_LEVEL_MAP),
  claudeSubscriptionModel("claude-sonnet-4-6", "Claude Sonnet 4.6 (Claude Code subscription)", 200000, 48000, CLAUDE_SUBSCRIPTION_4_6_THINKING_LEVEL_MAP),
  claudeSubscriptionModel("claude-opus-4-6", "Claude Opus 4.6 (Claude Code subscription)", 1000000, 64000, CLAUDE_SUBSCRIPTION_4_6_THINKING_LEVEL_MAP),
  claudeSubscriptionModel("claude-opus-4-7", "Claude Opus 4.7 (Claude Code subscription)", 1000000, 64000, CLAUDE_SUBSCRIPTION_OPUS_4_7_THINKING_LEVEL_MAP),
] as const;
